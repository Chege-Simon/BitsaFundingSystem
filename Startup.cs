...
namespace BitsaFundingSystem
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<BitsaFundingSystemContext>(options => options.UseSqlite(Configuration.GetConnectionString("BitsaFundingSystemContextConnection")));
            ...
            services.AddSingleton<P2PConnectionService>();
